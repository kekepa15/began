...
#           ________________________________________Layers_________________________________________________
			...
			reshaped_vector = tf.reshape(repeat_3, [FLAGS.bn_reverse, self.reshape_size_w*self.reshape_size_w*4*self.n])
...
#           ________________________________________Layers_________________________________________________
			...
			h_0 = tf.reshape(dense_layer, [FLAGS.bn_reverse, self.reshape_size_w, self.reshape_size_h, self.n])
